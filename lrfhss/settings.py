import numpy as np
import warnings
from lrfhss.traffic import Traffic


class Settings:
    def __init__(
        self,
        number_nodes=80000 // 8,
        ...
        if traffic_class is None:
            from lrfhss.traffic import Exponential_Traffic
            traffic_class = Exponential_Traffic
        if traffic_param is None:
        ...
        self.time_on_air = (
            self.header_duration * self.headers
            + self.payload_duration * self.payloads
