...
Finally, the file traffic.py implements different types of traffic generators to be used by Node objects. Plots were made with the [SciencePlots](https://github.com/garrettj403/SciencePlots) library.
